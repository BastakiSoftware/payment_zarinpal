...
class PaymentProvider(models.Model):
    ...
    zarinpal_merchant_id = fields.Char(
        ...
        help="Merchant ID provided by Zarinpal for processing payments.",
    )
...
class PaymentAcquirerZarinpal(models.Model):
    ...
    zarinpal_merchant_id = fields.Char(
        string="Merchant ID", required_if_provider="zarinpal"
    )
    ...
    def _zarinpal_get_api_url(self):
        return (
            ...
            if self.state == "test"
            else "https://www.zarinpal.com/pg/v4/payment/request.json"
        )
    ...
    def _zarinpal_get_verify_url(self):
        return (
            ...
            if self.state == "test"
            else "https://www.zarinpal.com/pg/v4/payment/verify.json"
        )
